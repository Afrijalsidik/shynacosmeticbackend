...
class BookingTransactionController extends Controller
{
    ...
    public function store(StoreBookingTransactionRequest $request)
    {
        try {
            ...
            // rettrie product and calculate total quantities and price
            ...
            // save total quantity in booking transaction
            $validatedData['quantity'] = $totalQuantity;

            $bookingTrancastion = BookingTransaction::create($validatedData);

            // create trancastion details for each product
            foreach ($products as $product) {
                $cosmetic = $cosmetics->firstWhere('id', $product['id']);
                $bookingTrancastion->transactionDetails()->create([
            ...
            // return booking trancastion with details
            return new BookingTransactionApiResource($bookingTrancastion->load(['transactionDetails', 'transactionDetails.cosmetic']));
